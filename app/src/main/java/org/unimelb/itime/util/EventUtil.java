...
public class EventUtil extends BaseUtil{
    ...
    public static int getCardTypeInvitation(Meeting meeting)
    {
        ...
        boolean hasResponded = userInvitee.getHasResponded() == Invitee.HAS_RESPONDED;
        boolean isUpdated = meeting.getUpdateField().length != 0;
                ...
                if (hasResponded){
                    switch (userInviteeStatus){
                        ...
                        case Invitee.STATUS_DECLINED:{
                            //return card 4 or 8(updated)
                            return isUpdated ? 8 : 4;
                        }
