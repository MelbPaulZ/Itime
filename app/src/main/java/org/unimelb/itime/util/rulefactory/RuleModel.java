            ...
            switch (frequencyEnum){
                ...
                case MONTHLY:{
                    ...
                    while((hasUntil ? currentAvailableDate < until.getTime() : true)
                        ...
                        if (isInRDate(dt) || (currentAvailableDate >= startRange
                                && !isInEXDate(dt))
                                ){
                            availableDates.add(currentAvailableDate);
                        }
                        ...
                        while (orgDayOfMonth > cal.getActualMaximum(Calendar.DAY_OF_MONTH)){
                            cal.add(Calendar.MONTH, interval);
                        }
                ...
                case YEARLY:{
                    ...
                    orgCal.setTimeInMillis(startTime);

                    int orgDayOfYear = orgCal.get(Calendar.DAY_OF_YEAR);
                    int orgDayOfMonth = orgCal.get(Calendar.DAY_OF_MONTH);
                    int compareDayOfMonth = cal.get(Calendar.DAY_OF_MONTH);

                    int orgMonthOfYear = orgCal.get(Calendar.MONTH);
                    int compareMonthOfYear = cal.get(Calendar.MONTH);

                    int diffYear = cal.get(Calendar.YEAR) - orgCal.get(Calendar.YEAR);
                    ...
                    while((hasUntil ? currentAvailableDate < until.getTime() : true)
                        ...
                        while (orgDayOfYear > cal.get(Calendar.DAY_OF_YEAR)){
                            cal.add(Calendar.YEAR, interval);
                        }
                        currentAvailableDate = cal.getTimeInMillis();
                    }
