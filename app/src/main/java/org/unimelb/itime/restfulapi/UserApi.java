...
public interface UserApi {
    ...
    @POST("user/timezone/update")
    Observable<HttpResult<Object>> updateTimezone(@Body HashMap<String, String> timezone);
...
//            Example: user/search/abc@gmail.com
    ...
    @GET("user/get/{userUid}")
    Observable<HttpResult<User>> get(@Path("userUid") String userUid);
...
//    "blockLevel" > 0 represents this user is blocked; "blockLevel"==0 represents this user is not blocked.
    @GET("user/blocklist")
    Observable<HttpResult<List<Block>>> listBlock(@Query("syncToken") String syncToken);
...
//  Description: Block a user.
    ...
    Observable<HttpResult<List<Domain>>> getDomainList();
