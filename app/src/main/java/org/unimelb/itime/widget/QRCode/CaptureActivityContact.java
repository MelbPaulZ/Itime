 ...
 * @author Sean Owen
 */
public final class CaptureActivityContact extends Activity implements ToolbarInterface, ItimeBaseMvpView, SurfaceHolder.Callback {
...
//    private ImagePicker imagePicker;
    ...
    public void onCreate(Bundle icicle) {
        ...
        toolbarViewModel.setTitle(getString(R.string.scan_qr_code));
        toolbarViewModel.setRightEnable(true);
        toolbarViewModel.setRightText(getString(R.string.scan_qr_code_album));
