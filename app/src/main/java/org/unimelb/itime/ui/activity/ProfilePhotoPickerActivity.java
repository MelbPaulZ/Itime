...
import static org.unimelb.itime.ui.fragment.event.FragmentEventEdit.REQUEST_CAMERA_PERMISSION;
...
//                                                startActivityForResult(intent, TAKE_PHOTO);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION && grantResults[0] == PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(getApplicationContext(), "need permission to take picture", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void updatePhoto(String localPath) throws IOException {
        ...
        file.saveInBackground(new SaveCallback() {
            ...
            public void done(AVException e) {
                ...
                ProfilePhotoPickerActivity.this.setResult(SettingSwitchActivity.TASK_TO_MY_PROFILE);
                finish();
            }
        });
    }
