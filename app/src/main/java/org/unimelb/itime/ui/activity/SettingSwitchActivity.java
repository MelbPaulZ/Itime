...
public class SettingSwitchActivity extends ItimeBaseActivity{
    ...
    public final static int TASK_TO_HELP = 20;
    public final static int TASK_TO_REPORT = 21;
    public final static int TASK_TO_LANGUAGE = 22;
        ...
        if (task != -100){
            switch (task){
                ...
                case TASK_TO_HELP_AND_FEEDBACK:
                    break;
                case TASK_TO_HELP:
//                    name = SettingHelpCenterFragment.class;
                    break;
                case TASK_TO_REPORT:
//                    name = SettingReportFragment.class;
                    break;
                case TASK_TO_ABOUT:
        ...
        try {
            fragmentManager.beginTransaction().
                    replace(getFragmentContainerId(), name.newInstance(), name.getSimpleName())
                    .commit();
        }catch (Exception e){
