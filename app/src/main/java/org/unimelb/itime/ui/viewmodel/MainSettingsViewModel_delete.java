...
public class MainSettingsViewModel_delete extends BaseObservable{
    ...
    private ItemBinding calendarItemView = ItemBinding.of(BR.calendar, R.layout.setting_default_calendar_listview);
    ...
    @Bindable
    public ItemBinding getCalendarItemView() {
        return calendarItemView;
    }

    public void setCalendarItemView(ItemBinding calendarItemView) {
        this.calendarItemView = calendarItemView;
        notifyPropertyChanged(BR.calendarItemView);
    }
