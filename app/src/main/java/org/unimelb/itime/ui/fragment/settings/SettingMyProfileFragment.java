...
public class SettingMyProfileFragment extends ItimeBaseFragment<UserMvpView, UserPresenter<UserMvpView>> implements ToolbarInterface, UserMvpView{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        toolbarViewModel.setTitle(getString(R.string.setting_my_profile));
