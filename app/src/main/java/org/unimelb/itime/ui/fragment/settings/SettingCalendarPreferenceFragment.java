...
public class SettingCalendarPreferenceFragment extends ItimeBaseFragment<CalendarPreferenceMvpView, MvpBasePresenter<CalendarPreferenceMvpView>> implements CalendarPreferenceMvpView, ToolbarInterface {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        toolbarViewModel.setTitle(getString(R.string.setting_calendar_pref));
