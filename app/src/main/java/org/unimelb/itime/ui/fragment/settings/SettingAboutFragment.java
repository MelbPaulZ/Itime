...
public class SettingAboutFragment extends ItimeBaseFragment<SettingCommonMvpView_delete, SettingCommonPresenter<SettingCommonMvpView_delete>>
implements ToolbarInterface, SettingCommonMvpView_delete {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        toolbarViewModel.setLeftIcon(
                getContext().getResources().getDrawable(R.drawable.icon_nav_back));
        toolbarViewModel.setTitle(getString(R.string.about));
